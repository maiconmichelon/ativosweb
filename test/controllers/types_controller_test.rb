...
class TypesControllerTest < ActionController::TestCase
  ...
  test "should create type" do
    assert_difference('Type.count') do
      post :create, type: { active: @type.active, description: @type.description, initial_code: @type.initial_code }
    end
  ...
  test "should update type" do
    patch :update, id: @type, type: { active: @type.active, description: @type.description, initial_code: @type.initial_code }
    assert_redirected_to type_path(assigns(:type))
  end
