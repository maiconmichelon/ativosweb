...
var pilotFieldsUI = {
    init: function() {
        ...
        // $('#new_type_component_fields').validateOnBlur();

        $('#addButton').on('click', function(e) {
            // If the form validation on our Pilots modal "form" fails, stop everything and prompt the user
            // to fix the issues.

            // var isValid = $('#new_type_component_fields').validate(false, validationSettings);
//            if(!isValid) {
//                e.stopPropagation();
//
//                return false;
...
var cfg = {
    formId: '#new_component_fields',
    tableId: '#components_table',
